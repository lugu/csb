...
object BetterConfig extends Config(Map(
  "angleDenumPilot1" -> 4,
  "anglePilotAvoid" -> 69,
  "choosePilot1Distance" -> 4050,
  "largeDistancePilotFight" -> 3195,
  "longDistanceBoost" -> 4644,
  "maxAngleCorrected" -> 18,
  "maxSpeed" -> 158,
  "maxSpeedCorrected" -> 207,
  "maxSpeedPilot0" -> 164,
  "maxSpeedPilot1" -> 134,
  "maxSpeedPilot2" -> 197,
  "maxSpeedPilotAvoid" -> 207,
  "maxSpeedPilotWait" -> 198,
  "minAngleCorrected" -> 119,
  "minSpeedCorrected" -> 78,
  "minSpeedOffsetCorrected" -> 134,
  "ratioPilot1" -> 2,
  "reactionDistanceCorrected" -> 4712,
  "skipAngle" -> 30,
  "skipAnglePilot2" -> 24,
  "skipDistance" -> 1649,
  "skipSpeed" -> 327,
  "skipSpeedPilot2" -> 196,
  "smallAngleBoost" -> 36,
  "smallDistancePilotWait" -> 2747,
  "speedFactorDenumCorrected" -> 21,
  "speedFactorNumCorrected" -> 11,
  "speedPilotHit" -> 207,
  "stepsToDestinationPilot2" -> 3))
